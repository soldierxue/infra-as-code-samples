module "spring-config" {
  ...
  target_group_arn ="${element(module.dmz-alb.target_group_arns,index(var.dmz_alb_tg_names,lookup(var.support_srv_params,"config.tg_name")))}"
}
...
module "spring-eureka" {
  ...
  ecs_service_role_arn = "${module.ecscluster1.ecs_service_role_arn}"
  target_group_arn ="${element(module.dmz-alb.target_group_arns,index(var.dmz_alb_tg_names,lookup(var.support_srv_params,"eureka.tg_name")))}"
}
...
module "spring-eureka2" {
  ...
  ecs_service_role_arn = "${module.ecscluster1.ecs_service_role_arn}"
  target_group_arn ="${element(module.dmz-alb.target_group_arns,index(var.dmz_alb_tg_names,lookup(var.support_srv_params,"eureka2.tg_name")))}"
}
